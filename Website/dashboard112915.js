...
function loadContent() {
    ...
    var contentNavigate = $(
        ...
        '       <form action="http://127.0.0.1:5000/" method="POST" action="">' +
        '       Origin: <input name="Origin" type="text"><br><br>'+
        '       Destination: <input name="Destination" type="text"><br>' +
        '       <input type="button" name="My button" value="Submit"><br>' +
        '       <input type="radio">Send my greetings' +
        '       </form>' +
        '      <div id="map"></div></div>' +
...
//    $('div#content').append(contentReports);
    ...
    var contentGallery = $(
      ...
      '     </div>'+
      '     <div class="col-md-8 content-left">'+
      '       <img src="EnergyData.png" style="width:100%;"/>'+
      '        <img src="board.jpg" style="width:100%;"/>'+
      '        <img src="Arduino.jpg" style="width:75%;"/>'+ 
      '        <img src="bikeChain.jpg" style="width:75%;"/>'+
      '        <img src="bike.jpg" style="width:75%;"/>'+
